...
namespace BroDirectX
{
    ...
    /// </summary>
    public partial class DXCanvas : UserControl
    {
        ...
        public Fragment LoadFragment(string fileName, InputElement[] inputElements)
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("BroDirectX.Shaders." + fileName))
            {
        ...
        public delegate void OnDrawHandler(DXCanvas canvas, Layer layer);
