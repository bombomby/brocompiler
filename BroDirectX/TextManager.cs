    ...
    public class TextManager : IDisposable
    {
        ...
        class Font : IDisposable
        {
            ...
            public static Font Create(Device device, String name)
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream(String.Format("BroDirectX.Fonts.{0}.fnt", name)))
                {
                    ...
                    using (Stream textureStream = assembly.GetManifestResourceStream(String.Format("BroDirectX.Fonts.{0}_0.png", name)))
                    {
